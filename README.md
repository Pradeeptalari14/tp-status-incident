# 🚨 Status & Incident Studio
> Scaffold PagerDuty/Opsgenie escalation chains, status dashboard config schemas, and incident triage runbooks.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/status-incident/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/status-incident/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-status-incident.git
cd tp-status-incident
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/status-incident/) |
