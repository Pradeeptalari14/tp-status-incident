# 🔧 Troubleshooting Guide — Status & Incident Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-status-incident/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/status-incident/)
